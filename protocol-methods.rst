...
**Result**
  ...
  The fee in whole coin units (DIME, not satoshis for Dimecoin) as a
...
Return a banner to be shown in the Electrum-Dime console.
...
**Result**
  ...
  * *protocol_min*
    ...
    Strings that are the minimum and maximum Electrum-Dime protocol
...
**Example**::
  ...
  server.version("Electrum-Dime 3.0.6", ["1.1", "1.2"])
