...
`pivx-quark-hash`Hashing module.version = 1.2 is **required**.                           
================ ========================
...
or higher and Dimecoin requires the pivx_quark_hash hashing module.
...
.. _`pivx_quark_hash`: https://pypi.org/project/pivx-quark-hash/